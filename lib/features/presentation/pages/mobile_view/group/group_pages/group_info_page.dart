          ...
          children: [
            ...
            groupData?.groupProfileImage != null
                ? CircleAvatar(
                    ...
                    radius: 20.sp,
                    backgroundImage:
                        NetworkImage(groupData!.groupProfileImage!),
                  )
            ...
            children: [
              Center(
                child: Column(
                  ...
                  children: [
                    ...
                    kHeight5,
                    TextWidgetCommon(
                      text: "${groupData?.groupMembers?.length} Members",
                      textAlign: TextAlign.center,
              ...
              Column(
                ...
                children: [
                  ...
                  TextWidgetCommon(
                    text: groupData?.groupDescription ?? 'No Description',
                    overflow: TextOverflow.ellipsis,
                    fontSize: 14.sp,
                    textColor: iconGreyColor,
                  ),
              ...
              Column(
                ...
                children: [
                  TextWidgetCommon(
                    text: "Members (${groupData!.groupMembers?.length})",
                    overflow: TextOverflow.ellipsis,
                    fontSize: 14.sp,
                    textColor: iconGreyColor,
                  ),
              ...
              commonListTile(
                onTap: () {},
                title: "Block ${groupData?.groupName ?? ''}",
                isSmallTitle: false,
                context: context,
                color: kRed,
                leading: Icon(
              ...
              commonListTile(
                onTap: () {},
                title: "Report ${groupData?.groupName ?? ''}",
                isSmallTitle: false,
                context: context,
                color: kRed,
                leading: Icon(
